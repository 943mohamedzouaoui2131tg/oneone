...
function App() {
  ...
  const panimatie = document.querySelectorAll('.home > .top > .container > .top > .left > div > p')
  const spananimatie = document.querySelectorAll('.home > .top > .container > .top > .left > div >  span')
  const prightanimatie = document.querySelector('.home > .top > .container > .top > .right > p')
  const landingbg = document.querySelector('.home > .top > .landing')
  const lianimatie = document.querySelectorAll('.nav-bar .container > ul > li')
  ...
  return (
    ...
    <div className="App">
      ...
      <div ref={masterLoader} className="loaderMaster">
          <div ref={countRef} className="count">{countH}%</div>
          <div ref={prog} className="prog"></div>
      </div>
    <Routes>
      <Route element={<Layout ref={logoanimate}/>} >
